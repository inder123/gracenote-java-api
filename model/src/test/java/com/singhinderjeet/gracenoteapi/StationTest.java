...
public class StationTest {
  ...
  public void testChannelJson() throws Exception {
    ...
    InputStream is = StationTest.class.getResourceAsStream("/station-details.json");
    List<Station> stations = gson.fromJson(new InputStreamReader(is), stationListType);
    assertEquals(2, stations.size());
    Station station = stations.get(0);
    assertEquals("CW", station.getAffiliateCallSign());
    String json = gson.toJson(stations);
    assertTrue(json.contains("h3/NowShowing/10161/s10161_h3_aa.png"));
  }
}
