...
public class ChannelTest {
  ...
  public void testChannelJson() throws Exception {
    ...
    InputStream is = ChannelTest.class.getResourceAsStream("/lineup-channels.json");
    List<Channel> channels = gson.fromJson(new InputStreamReader(is), channelListType);
    assertEquals(3, channels.size());
    Channel channel = channels.get(1);
    assertEquals("ION", channel.getAffiliateCallSign());
    String json = gson.toJson(channels);
    assertTrue(json.contains("h3/NowShowing/10991/s10991_h3_aa.png"));
  }
}
